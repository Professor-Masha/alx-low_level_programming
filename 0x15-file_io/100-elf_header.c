 ...
 * @e_ident: The pointer to an array containing the ELF No.
 *
...
/**
 * print_magic - A funtion that prints the No of an ELF header.
 * @e_ident: A pointer to an array containing the ELF No
 *
...
/**
 * print_type - A fun prints the type of an ELF.
 * @e_type: The ELF type
...
/**
 * print_entry - A fun that prints the entry of an ELF header
...
/**
 * close_elf - A fun that closes an ELF file.
...
/**
 * main - A fun that Displays the info contained in the
 * ELF header at the start of an ELF file.
 * @argc: The No of arguments supplied to the prg
 * @argv: An array of ponts to the arg.
 *
 * Return: 0 on success
 *
